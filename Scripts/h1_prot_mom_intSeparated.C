...
void h1_prot_mom_intSeparated( std::string file_name){
    ...
    else { std::cout << "You have entered an invalid/unknown target. Consider adding code to accomodate this target in h1_prot_mom_intSeparated.C." << std::endl; }
    ...
    else { std::cout << "You have entered an invalid/unknown beam energy. Consider adding code to accomodate this beam energy in h1_prot_mom_intSeparated.C" << std::endl; }
    ...
    TH1F* h1_prot_momentum[24];

    h1_prot_momentum[0] = (TH1F*)input1->Get(TString::Format("h1_1_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__5"));
    h1_prot_momentum[1] = (TH1F*)input1->Get(TString::Format("h1_2_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__5"));
    h1_prot_momentum[2] = (TH1F*)input1->Get(TString::Format("h1_3_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__5"));
    h1_prot_momentum[3] = (TH1F*)input1->Get(TString::Format("h1_4_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__5"));

    h1_prot_momentum[4] = (TH1F*)input1->Get(TString::Format("h1_1_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__4"));
    h1_prot_momentum[5] = (TH1F*)input1->Get(TString::Format("h1_2_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__4"));
    h1_prot_momentum[6] = (TH1F*)input1->Get(TString::Format("h1_3_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__4"));
    h1_prot_momentum[7] = (TH1F*)input1->Get(TString::Format("h1_4_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__4"));

    h1_prot_momentum[8] = (TH1F*)input1->Get(TString::Format("h1_1_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__3"));
    h1_prot_momentum[9] = (TH1F*)input1->Get(TString::Format("h1_2_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__3"));
    h1_prot_momentum[10] = (TH1F*)input1->Get(TString::Format("h1_3_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__3"));
    h1_prot_momentum[11] = (TH1F*)input1->Get(TString::Format("h1_4_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__3"));

    h1_prot_momentum[12] = (TH1F*)input1->Get(TString::Format("h1_1_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__2"));
    h1_prot_momentum[13] = (TH1F*)input1->Get(TString::Format("h1_2_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__2"));
    h1_prot_momentum[14] = (TH1F*)input1->Get(TString::Format("h1_3_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__2"));
    h1_prot_momentum[15] = (TH1F*)input1->Get(TString::Format("h1_4_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__2"));

    h1_prot_momentum[16] = (TH1F*)input1->Get(TString::Format("h1_1_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__1"));
    h1_prot_momentum[17] = (TH1F*)input1->Get(TString::Format("h1_2_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__1"));
    h1_prot_momentum[18] = (TH1F*)input1->Get(TString::Format("h1_3_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__1"));
    h1_prot_momentum[19] = (TH1F*)input1->Get(TString::Format("h1_4_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__1"));

    h1_prot_momentum[20] = (TH1F*)input1->Get(TString::Format("h1_1_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__0"));
    h1_prot_momentum[21] = (TH1F*)input1->Get(TString::Format("h1_2_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__0"));
    h1_prot_momentum[22] = (TH1F*)input1->Get(TString::Format("h1_3_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__0"));
    h1_prot_momentum[23] = (TH1F*)input1->Get(TString::Format("h1_4_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__0"));
...
//        h1_prot_momentum[i]->GetYaxis()->SetTitleSize( 0.06);
        ...
        if (cut_case.compare("noCuts") == 0) { h1_prot_momentum[i]->SetTitle(TString(target_plot)+" with "+TString(beam_energy_plot)+" Beam (No Cuts)"); }
	else if ( cut_case.compare("incl_noElMomCut") == 0) { h1_prot_momentum[i]->SetTitle("#splitline{"+TString(target_plot)+" with "+TString(beam_energy_plot)+" Beam}{#Delta#phi_{e^{-}} = "+TString(deltaPhiEl)+"#circ, e^{-} Sectors "+TString(elSectors_plot)+", "+TString(thetaEl_lb)+"#circ < #theta_{e^{-}} < "+TString(thetaEl_ub)+"#circ}"); }
        else if ( cut_case.compare("incl") == 0) { h1_prot_momentum[i]->SetTitle("#splitline{"+TString(target_plot)+" with "+TString(beam_energy_plot)+" Beam}{#Delta#phi_{e^{-}} = "+TString(deltaPhiEl)+"#circ, e^{-} Sectors "+TString(elSectors_plot)+", "+TString(thetaEl_lb)+"#circ < #theta_{e^{-}} < "+TString(thetaEl_ub)+"#circ, p_{e^{-}} > "+TString(elMom_lb_plot)+"}"); }
        else if ( cut_case.compare("excl") == 0) { h1_prot_momentum[i]->SetTitle("#splitline{"+TString(target_plot)+" with "+TString(beam_energy_plot)+" Beam}{#Delta#phi_{e^{-}} = "+TString(deltaPhiEl)+"#circ, e^{-} Sectors "+TString(elSectors_plot)+", "+TString(thetaEl_lb)+"#circ < #theta_{e^{-}} < "+TString(thetaEl_ub)+"#circ, p_{e^{-}} > "+TString(elMom_lb_plot)+", p^{+} Sectors "+TString(protSectors_plot)+", #Delta#phi_{p^{+}} = "+TString(deltaPhiProt)+", "+TString(thetaProt_lb)+"#circ < #theta_{p^{+}} < "+TString(thetaProt_ub)+"#circ}"); }
	else if ( cut_case.compare("excl_withProtMomCut") == 0) { h1_prot_momentum[i]->SetTitle("#splitline{"+TString(target_plot)+" with "+TString(beam_energy_plot)+" Beam}{#Delta#phi_{e^{-}} = "+TString(deltaPhiEl)+"#circ, e^{-} Sectors "+TString(elSectors_plot)+", "+TString(thetaEl_lb)+"#circ < #theta_{e^{-}} < "+TString(thetaEl_ub)+"#circ, p_{e^{-}} > "+TString(elMom_lb_plot)+", p^{+} Sectors "+TString(protSectors_plot)+", #Delta#phi_{p^{+}} = "+TString(deltaPhiProt)+", "+TString(thetaProt_lb)+"#circ < #theta_{p^{+}} < "+TString(thetaProt_ub)+"#circ, p_{p^{+}} > "+TString(protMom_lb)+"}"); }
    
        // take the maximum of the four interactions to use later in plotting
        if (h1_prot_momentum[i]->GetMaximum() > hist_max) { hist_max = h1_prot_momentum[i]->GetMaximum(); }
    }
    ...
    legend->AddEntry( h1_prot_momentum[20],"QE","l");
    legend->AddEntry( h1_prot_momentum[21],"MEC","l");
    legend->AddEntry( h1_prot_momentum[22],"RES","l");
    legend->AddEntry( h1_prot_momentum[23],"DIS","l");
    ...
    //          it to the screen
    int num_QE_events = h1_prot_momentum[20]->Integral();
    int num_MEC_events = h1_prot_momentum[21]->Integral();
    int num_RES_events = h1_prot_momentum[22]->Integral();
    int num_DIS_events = h1_prot_momentum[23]->Integral();
