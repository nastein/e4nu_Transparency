...
void prot_trans_vs_prot_mom_targetC12_beamEnergy1161_exclusivePlus_test(){
	...
	const int N_RANGES = 1; // number of Ranges; see similarities in thetaEl arguments in file_names below
	...
	const int color_options[N_RANGES] = {kBlue}; // colors of each Range plotted
        const char* mc_draw_options[N_RANGES] = {"HIST"};
        const char* data_draw_options[N_RANGES] = {"E1 SAME"};
...
//	double corrRange[3] = {4900./(4900. + 1800.), 1830./(1830. + 830.), 395./(395. + 205.)};
	//double corrRange[3] = {.83075,.7228,.6489};
	double corrRange[3] = {0.72332173,0,0};
	//double corrRange[3] = {0.63630269,0,0};
	//double corrRange[3] = {.71931989,0,0};
	//double corrRange[3] = {.69620435,0,0};
	//double corrRange[3] = {.63031,.5653,.55619};
...
// Users don't have to read all the code below this dashed line unless they want to do a deep dive into the code, or if they want to debug, etc.
	...
	std::string mc_file_path ("/pnfs/genie/persistent/users/gchamber/output2022/Analysis14/test2/");
	...
	std::string mc_incl[N_RANGES];
        ...
        mc_incl[0] = mc_file_path + "Inclusive/Inclusive_Range1_Genie_1_C12_4.461000.root";
        mc_excl[0] = mc_file_path + "Exclusive/Exclusive_Range1_Genie_1_C12_4.461000.root";

        //data_incl[0] = data_file_path + "test/Inclusive_Range1_Data__C12_4.461000.root";
        data_incl[0] = data_file_path + "Inclusive/Inclusive_Range1_Data__C12_4.461000.root";
        //data_excl[0] = data_file_path + "test/Exclusive_Range1_Data__C12_4.461000.root";
        data_excl[0] = data_file_path + "Exclusive/Exclusive_Range1_Data__C12_4.461000.root";
	...
	TCanvas* c2;
        ...
        TFile *output = TFile::Open("../output/trans_vs_prot_mom/C12_4461.root", "RECREATE");
        output->cd();
        g1_data_conglomerate_trans->Write("data_graph");
        g1_mc_conglomerate_trans->Write("genie_graph");
        //c2->SaveAs(TString::Format("../output/trans_vs_prot_mom/trans_vs_prot_mom_targetC12_beamEnergy4461_exclusivePlus_conglom.pdf"));
}
