...
void prot_trans_vs_prot_mom_target4He_beamEnergy2261_exclusivePlus(){
	...
	double corrRange[3] = {.75006269,.71522054,.71470676};
...
// Users don't have to read all the code below this dashed line unless they want to do a deep dive into the code, or if they want to debug, etc.
	...
	std::string mc_file_path ("/genie/app/users/gchamber/e4nu_2022/e4nu/output/output2022/FourthAnalysis/");
	std::string data_file_path ("/genie/app/users/gchamber/e4nu_2022/e4nu/output/output2022/FourthAnalysis/");
	...
	std::string mc_incl[N_RANGES];
        ...
        mc_incl[0] = mc_file_path + "Inclusive_Range1_Genie_1_4He_2.261000.root";
        mc_incl[1] = mc_file_path + "Inclusive_Range2_Genie_1_4He_2.261000.root";
        mc_incl[2] = mc_file_path + "Inclusive_Range3_Genie_1_4He_2.261000.root";
        mc_excl[0] = mc_file_path + "Exclusive_Range1_Genie_1_4He_2.261000.root";
        mc_excl[1] = mc_file_path + "Exclusive_Range2_Genie_1_4He_2.261000.root";
        mc_excl[2] = mc_file_path + "Exclusive_Range3_Genie_1_4He_2.261000.root";

        data_incl[0] = data_file_path + "Inclusive_Range1_Data__4He_2.261000.root";
        data_incl[1] = data_file_path + "Inclusive_Range2_Data__4He_2.261000.root";
        data_incl[2] = data_file_path + "Inclusive_Range3_Data__4He_2.261000.root";
        data_excl[0] = data_file_path + "Exclusive_Range1_Data__4He_2.261000.root";
        data_excl[1] = data_file_path + "Exclusive_Range2_Data__4He_2.261000.root";
        data_excl[2] = data_file_path + "Exclusive_Range3_Data__4He_2.261000.root";
	...
	TCanvas* c2;
        ...
        TFile *output = TFile::Open("../output/trans_vs_prot_mom/4He_2261.root", "RECREATE");
        output->cd();
        g1_data_conglomerate_trans->Write("data_graph");
        g1_mc_conglomerate_trans->Write("genie_graph");
        //c2->SaveAs(TString::Format("../output/trans_vs_prot_mom/trans_vs_prot_mom_target4He_beamEnergy2261_exclusivePlus_conglom.pdf"));
}
