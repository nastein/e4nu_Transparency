        ...
        for(int p = 0; p < 2; p++) {
                for(int s : sectors) {
                        ...
                        for(int r = 0; r < 3; r++) {
                                ...
                                UniversalE4vFunction(SuSA_2261_true_reco[r][p][s],  FSIModelsToLabels["SuSav2_NoRadCorr_LFGM_Truth_WithFidAcc"], "56Fe","2_261", TString::Format("susa_2261_mom_truereco_%i%i%i",r,p,s));
                                UniversalE4vFunction(G_2261_true_reco[r][p][s],  FSIModelsToLabels["hA2018_Final_NoRadCorr_LFGM_Truth_WithFidAcc"], "56Fe","2_261", TString::Format("g_2261_mom_truereco_%i%i%i",r,p,s));
                        }   
                        ...
                        for(int r = 0; r < 1; r++) {
                                ...
                                UniversalE4vFunction(SuSA_4461_true_reco[r][p][s],  FSIModelsToLabels["SuSav2_NoRadCorr_LFGM_Truth_WithFidAcc"], "56Fe","4_461", TString::Format("susa_4461_mom_truereco_%i%i%i",r,p,s));
                                UniversalE4vFunction(G_4461_true_reco[r][p][s],  FSIModelsToLabels["hA2018_Final_NoRadCorr_LFGM_Truth_WithFidAcc"], "56Fe","4_461", TString::Format("g_4461_mom_truereco_%i%i%i",r,p,s));
                        }
                }
        }
...
// --------------------- Getting Data exclusive and inclusive measurements ----------------
        ...
        for(int p = 0; p < 2; p++) {
                for(int s : sectors) {
                        ...
                        UniversalE4vFunction(Data_2261[2][p][s], "Pinned Data", "56Fe", "2_261", TString::Format("data %s %i",second_en[2][p].c_str(),s));
                        UniversalE4vFunction(Data_4461[0][p][s], "Pinned Data", "56Fe", "4_461", TString::Format("data %s %i",third_en[0][p].c_str(),s));
                }
        }
                ...
                for(int s : sectors) {
                        for(int p = 0; p < 2; p++) {
                                ...
                                for(int r = 0; r< 3; r++ ) {
                                        ...
                                        SuSA_2261[r][p][s]->SetTitle("SuSA_v2 Fe56");
                                        Data_2261[r][p][s]->SetTitle("Data Fe56");
                                        G_2261[r][p][s]->Draw("e same");
                                        G_2261[r][p][s]->SetTitle("G18 Fe56");
                                ...
                                for(int r = 0; r < 1; r++ ) {
                                        ...
                                        SuSA_4461[r][p][s]->SetTitle("SuSA_v2 Fe56");
                                        Data_4461[r][p][s]->SetTitle("Data Fe56");
