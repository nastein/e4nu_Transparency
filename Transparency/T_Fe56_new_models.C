...
void T_Fe56_new_models(bool make_plots = false) {
        gStyle->SetOptStat(0);
        ...
        susa_2261[0][0] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hA_LFG_range1_Genie_1_56Fe_2.261000.root";
        susa_2261[0][1] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hA_LFG_range1_Genie_1_56Fe_2.261000.root";
        susa_2261[1][0] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hA_LFG_range2_Genie_1_56Fe_2.261000.root";
        susa_2261[1][1] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hA_LFG_range2_Genie_1_56Fe_2.261000.root";
        susa_2261[2][0] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hA_LFG_range3_Genie_1_56Fe_2.261000.root";
        susa_2261[2][1] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hA_LFG_range3_Genie_1_56Fe_2.261000.root";

        std::string susa_2261_CFG[4][2];

        susa_2261_CFG[0][0] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hA_CFG_range1_Genie_1_56Fe_2.261000.root";
        susa_2261_CFG[0][1] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hA_CFG_range1_Genie_1_56Fe_2.261000.root";
        susa_2261_CFG[1][0] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hA_CFG_range2_Genie_1_56Fe_2.261000.root";
        susa_2261_CFG[1][1] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hA_CFG_range2_Genie_1_56Fe_2.261000.root";
        susa_2261_CFG[2][0] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hA_CFG_range3_Genie_1_56Fe_2.261000.root";
        susa_2261_CFG[2][1] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hA_CFG_range3_Genie_1_56Fe_2.261000.root";

        std::string susa_2261_LFG_hN[4][2];

        susa_2261_LFG_hN[0][0] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hN_LFG_range1_Genie_1_56Fe_2.261000.root";
        susa_2261_LFG_hN[0][1] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hN_LFG_range1_Genie_1_56Fe_2.261000.root";
        susa_2261_LFG_hN[1][0] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hN_LFG_range2_Genie_1_56Fe_2.261000.root";
        susa_2261_LFG_hN[1][1] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hN_LFG_range2_Genie_1_56Fe_2.261000.root";
        susa_2261_LFG_hN[2][0] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hN_LFG_range3_Genie_1_56Fe_2.261000.root";
        susa_2261_LFG_hN[2][1] = "/genie/app/users/nsteinbe/grahams_e4nu/CLAS/GENIE/Alternate_models/SuSAv2_hN_LFG_range3_Genie_1_56Fe_2.261000.root";
...
// -------------- Correct for MEC and neutron contamination --------------
        ...
        double neutron_corr_2261_G18[4][2] = {{0.725,0.725},{0.672,0.672},{0.665,0.665},{0.697,0.697}};
...
// ---------------------------------------------------------------------
        ...
        double comb_mc_ypoints_CFG[3] = {SuSA_comb_T_2261_CFG[0], SuSA_comb_T_2261_CFG[1], SuSA_comb_T_2261_CFG[2]};

        double comb_mc_ypoints_LFG_hN[3] = {SuSA_comb_T_2261_LFG_hN[0], SuSA_comb_T_2261_LFG_hN[1], SuSA_comb_T_2261_LFG_hN[2]};

        double comb_mc_ypoint_errs[3];
        double comb_mc_ypoint_errs_CFG[3];
        double comb_mc_ypoint_errs_LFG_hN[3];
        ...
        double comb_mc_xpoints_CFG[3] = {SuSA_comb_avg_prot_mom_2261_CFG[0], SuSA_comb_avg_prot_mom_2261_CFG[1], SuSA_comb_avg_prot_mom_2261_CFG[2]};

        double comb_mc_xpoints_LFG_hN[3] = {SuSA_comb_avg_prot_mom_2261_LFG_hN[0], SuSA_comb_avg_prot_mom_2261_LFG_hN[1], SuSA_comb_avg_prot_mom_2261_LFG_hN[2]};

        double comb_mc_xpoint_errs[3] = {0.0,0.0,0.0};
	...
	susa_comb_t->SetMarkerColor(12);
        ...
        c_susa->SaveAs("T_56Fe_SuSA_LFG_HA.pdf");
        ...
        //susa_comb_t = new TGraphErrors(6, comb_mc_xpoints, comb_mc_ypoints, comb_mc_xpoint_errs, comb_mc_ypoint_errs);
        susa_comb_t_CFG = new TGraphErrors(3, comb_mc_xpoints_CFG, comb_mc_ypoints_CFG, comb_mc_xpoint_errs, comb_mc_ypoint_errs_CFG);
        ...
        for(int s = 0; s < 6; s++){
                //susa_t[s] = new TGraphErrors(6, mc_xpoints[s], mc_ypoints[s], mc_xpoint_errs[s], mc_ypoint_errs[s]);
                susa_t_CFG[s] = new TGraphErrors(3, mc_xpoints_CFG[s], mc_ypoints_CFG[s], mc_xpoint_errs[s], mc_ypoint_errs_CFG[s]);
        ...
        c_susa->SaveAs("T_56Fe_SuSA_CFG_HA.pdf");
        ...
        //susa_comb_t = new TGraphErrors(6, comb_mc_xpoints, comb_mc_ypoints, comb_mc_xpoint_errs, comb_mc_ypoint_errs);
        susa_comb_t_LFG_hN = new TGraphErrors(3, comb_mc_xpoints_LFG_hN, comb_mc_ypoints_LFG_hN, comb_mc_xpoint_errs, comb_mc_ypoint_errs_LFG_hN);
        ...
        for(int s = 0; s < 6; s++){
                //susa_t[s] = new TGraphErrors(6, mc_xpoints[s], mc_ypoints[s], mc_xpoint_errs[s], mc_ypoint_errs[s]);
                susa_t_LFG_hN[s] = new TGraphErrors(3, mc_xpoints_LFG_hN[s], mc_ypoints_LFG_hN[s], mc_xpoint_errs[s], mc_ypoint_errs_LFG_hN[s]);
        ...
        c_susa->SaveAs("T_56Fe_SuSA_LFG_HN.pdf");
	...
	SuSA_trans_LFG_hN->SetName("SuSAv2 LFG HN");
        ...
        c_comb->SaveAs("T_56Fe_CFG_LFG_comp.pdf");

	TFile *file = TFile::Open("T_56Fe_Alternate_models.root", "RECREATE");
        SuSA_trans->Write();
        ...
        for(int r = 0; r < 3; r++) {
                ...
                c_proton[r] = new TCanvas(TString::Format("prot mom %d",r), TString::Format("prot mom %d",r), 800, 500);
                ...
                if(r < 3)  {
                        SuSA_comb_2261[r][0]->Scale(1./(20.e6));
                        SuSA_comb_2261_CFG[r][0]->Scale(1./(79200000.));
                        SuSA_comb_2261_LFG_hN[r][0]->Scale(1./(13.2e6));
                }
        ...
        for(int r = 0; r < 3; r++) {
                ...
                c_elect[r] = new TCanvas(TString::Format("elect mom %d",r), TString::Format("elec mom %d",r), 800, 500);
                ...
                if(r < 3)  {
                        SuSA_comb_2261[r][1]->Scale(1./(20.e6));
                        SuSA_comb_2261_CFG[r][1]->Scale(1./(79200000.));
                        SuSA_comb_2261_LFG_hN[r][1]->Scale(1./(13.2e6));
                }
        ...
        //TFile *final = TFile::Open("T_56Fe_sectors.root", "RECREATE");
        //G18_trans->Write("G_56Fe");
        //SuSA_trans->Write("SuSA_56Fe");
        //Data_trans->Write("data_56Fe");
        //final->Close();  
