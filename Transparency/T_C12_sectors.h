...
#include <string>
        ...
        std::string g_2261_truereco[4][2];
        ...
        std::string g_2261_true[4][2];
        std::string g_4461_true[1][2];

        // MC rad corr files
        std::string susa_1161_truereco_rad[2][2];
        std::string susa_2261_truereco_rad[4][2];
